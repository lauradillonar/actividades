...
# ---------------------------------------
# Trabajando con formularios: CALCULADORA
# https://github.com/josedom24/curso_flask/tree/master/curso/u18
...
def calculadora_get():
    if request.method == "GET" and len(request.args)>0:
        ...
        try:
            ...
            return render_template("error.html", "No puedo realizar la operación.")
        return render_template("resultado.html", num1=num1, num2=num2, operador=operador, resultado=resultado)
    else:
        return render_template("calculadora_get.html")    


# Utilizando rutas dinámicas:
